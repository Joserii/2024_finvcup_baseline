...
from utils.dataLoader import train_loader, eval_loader
...
parser.add_argument('--C',          type=int,   default=1024,    help='The param in ECAPA-TDNN')
parser.add_argument('--m',          type=float, default=0.2,     help='The param in AAMsoftmax')
parser.add_argument('--s',          type=int,   default=30,      help='The param in AAMsoftmax')
...
if args.eval == True:
    ...
    EER, minDCF = s.eval_network(loader = evalLoader)
...
while(1):
    ...
    if epoch % args.test_step == 0:
        ...
        acc_pred, recall_pred, f1_pred = s.eval_network(loader = evalLoader)
