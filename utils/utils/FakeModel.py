...
class FakeModel(nn.Module):
    def __init__(self, lr, lr_decay, n_class, device, test_step, **kwargs):
        ...
        self.speaker_encoder=RawNet3(Bottle2neck,model_scale=8,context=True,summed=True,encoder_type="ECA",nOut=256,out_bn=False,sinc_stride=10,log_sinc=True,norm_sinc="mean",grad_mult=1,n_class=2, m=0.2,s=30).to(self.device)
